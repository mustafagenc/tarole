...
export const SHARE_URL = 'https://tarole.vercel.app/';
export const LICENSE_URL =
  'https://github.com/mustafagenc/tarole?tab=Apache-2.0-1-ov-file#readme';

export const ROUTES = ['', '/about', '/contact', '/privacy'];
...
export const locales = [
  ...
  { id: 'uz', name: "O'zbek", flag: '/flags/uz.svg' },
